...
function widgets:RenderButton(button, angle)
	...
	self:RenderBox( button.left, button.top, button.width, button.height, button.corner )
	self:ClipRegion(button.left+button.border, button.top+button.border, button.width-button.border, button.height-button.border)
	...
	self:RenderText( button.name, brdr, bs * 0.5 + (txthgt * 0.25), txthgt, button.color )	
